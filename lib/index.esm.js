import React, { useState, useRef, useMemo, useImperativeHandle, useCallback, useLayoutEffect, useEffect } from 'react';
...
var TileSlider = React.forwardRef(function (_a, ref) {
    ...
    var _o = useState(0), index = _o[0], setIndex = _o[1];
    var _p = useState(0), slideToIndex = _p[0], setSlideToIndex = _p[1];
    var _q = useState(0), transform = _q[0], setTransform = _q[1];
    var _r = useState(false), doAnimationReset = _r[0], setDoAnimationReset = _r[1];
    var _s = useState(false), didSlideBefore = _s[0], setDidSlideBefore = _s[1];
    var _t = useState(false), afterReset = _t[0], setAfterReset = _t[1];
    var frameRef = useRef();
    ...
    var renderIdsArr = useMemo(function () { return Array.from({ length: isMultiPage ? renderCount + 1 : renderCount }, function (_, i) { return i; }); }, [renderCount, isMultiPage]);
    useImperativeHandle(ref, function () { return ({
        slideRight: function () { return slide('right'); },
        slideLeft: function () { return slide('left'); },
    }); });
    /**
    ...
    var renderTiles = function () {
        ...
        for (var i = start; i < end; i++) {
            ...
            tiles.push(React.createElement("li", { className: 'tile', key: key, 
    ...
    return (React.createElement("div", { className: clx('root', className) },
        ...
        React.createElement("ul", { ref: frameRef, className: 'container', style: ulStyle, onTouchStart: handleTouchStart, onTransitionEnd: handleTransitionEnd },
