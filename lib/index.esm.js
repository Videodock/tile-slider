...
var TileDock = function (_a) {
    ...
    var _k = useState(0), slideToIndex = _k[0], setSlideToIndex = _k[1];
    var _l = useState(-100), transform = _l[0], setTransform = _l[1];
    var _m = useState(false), doAnimationReset = _m[0], setDoAnimationReset = _m[1];
    var _o = useState(), touchPosition = _o[0], setTouchPosition = _o[1];
    ...
    return (React.createElement("div", { className: "tileDock" },
        showLeftControl && (React.createElement("div", { className: "leftControl" }, renderLeftControl({ handleClick: slideLeft }))),
        React.createElement("ul", { ref: frameRef, style: {
            ...
            return (React.createElement("li", { key: "visibleTile" + listIndex, "data-index": item.index, style: {
                    width: tileWidth + "%",
        ...
        offsetCompensation > 0 && isMultiPage && (React.createElement("div", { className: "offsetTile", style: { background: renderGradientEdge() } })),
        showRightControl && (React.createElement("div", { className: "rightControl" }, renderRightControl({ handleClick: slideRight })))));
};

export { CYCLE_MODE_ENDLESS, CYCLE_MODE_RESTART, CYCLE_MODE_STOP, TileDock };
