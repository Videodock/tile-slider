...
var TileSlider = function (_a) {
    ...
    var renderSinglePageTiles = function () {
        return items.map(function (item, index) {
            var key = "tile_" + index;
            return (React__default['default'].createElement("li", { className: 'tile', key: key, "aria-label": renderAriaLabel && renderAriaLabel(item, index, key, items.length), style: {
                    width: tileWidth + "%",
    ...
    var renderMultiPageTiles = function () {
        ...
        for (var renderIndex = state.index; renderIndex < end; renderIndex++) {
            ...
            var indexOverscanCompensation = renderIndex - tilesToShow - 1;
            var indexOfItem = getCircularIndex(indexOverscanCompensation, items.length);
            var circularIndex = getCircularIndex(indexOverscanCompensation, renderAmount);
    ...
    return (React__default['default'].createElement("div", { className: clx('root', className) },
        ...
        React__default['default'].createElement("ul", { ref: frameRef, className: 'container', style: ulStyle, onTouchStart: isMultiPage ? handleTouchStart : undefined, onTransitionEnd: handleTransitionEnd },
