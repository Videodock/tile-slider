...
var TileSlider = function (_a) {
    ...
    var paginationDots = function () {
        if (showDots && isMultiPage && !!renderPaginationDots) {
            var length_1 = pages;
            return (React.createElement("div", { className: "TileSlider-dots" }, Array.from({ length: length_1 }, function (_, pageIndex) {
    ...
    var renderSinglePageTiles = function () {
        return items.map(function (item, index) {
            ...
            return (React.createElement("li", { className: "TileSlider-tile", key: key, "aria-label": renderAriaLabel && renderAriaLabel(item, index, key, items.length), style: {
    ...
    var renderMultiPageTiles = function () {
        ...
        for (var renderIndex = state.index; renderIndex < end; renderIndex++) {
            ...
            tiles.push(React.createElement("li", { className: "TileSlider-tile", key: key, "aria-label": renderAriaLabel && renderAriaLabel(item, indexOfItem, key, items.length), style: {
                    width: "".concat(tileWidth, "%"),
                    paddingLeft: spacing / 2,
                    paddingRight: spacing / 2,
    ...
    return (React.createElement("div", { className: clx('TileSlider-root', className) },
        showLeftControl && !!renderLeftControl && (React.createElement("div", { className: "TileSlider-leftControl" }, renderLeftControl({
            onClick: function () { return slide('left'); },
            disabled: leftControlDisabled,
        }))),
        React.createElement("ul", { ref: frameRef, className: "TileSlider-container", style: ulStyle, onTouchStart: isMultiPage ? handleTouchStart : undefined, onTransitionEnd: handleTransitionEnd },
            wrapWithEmptyTiles ? (React.createElement("li", { className: "TileSlider-emptyTile", style: {
                    width: "".concat(tileWidth, "%"),
                    paddingLeft: spacing / 2,
                    paddingRight: spacing / 2,
                } })) : null,
        ...
        showRightControl && !!renderRightControl && (React.createElement("div", { className: "TileSlider-rightControl" }, renderRightControl({
